...
7. **Completed courses:** 
Modern Front-End using JavaScript and HTML5 (Belhard Academy), Learning Web App Development (Belhard Academy), HTML Academy’s courses of JavaScript, HTML5 and CSS3.
    **Education:** 
